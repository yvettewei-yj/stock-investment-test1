...
module.exports = function handler(req, res) {
  ...
  try {
    ...
    // path参数可能在 req.query.path 中，也可能需要从URL解析
    ...
    if (req.url) {
      ...
      // URL格式：/api/learning/questions -> parts = ['api', 'learning', 'questions']
    ...
    // 备用方法：尝试从req.query.path获取（Vercel标准方式）
    if (!path && req.query && typeof req.query === 'object' && req.query.path) {
      path = req.query.path;
    }
